...
* ``Single tile``: use the single tile mode (For future use).
* ``Auth``: the kind of authentication we should used (For future use).
...
The roles ans the Theme can have some functionalities. Attributes:
